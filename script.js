...
function clik (btn){
  btn.textContent == "Iya 🤗" ? img.src = "maluu.gif" : img.src = "patahHati.gif" 
  button[0].style.display = "none"
  button[1].style.display = "none"
  ctn.style.height = "250px"
  ctn.style.width = "270px"
  return btn.textContent == "Iya 🤗" ? kata.textContent = "😍 ni buat sayangku yang paling cantikk🍊" : kata.textContent = "😭😭😭😭😭😭"
...
function content(){
  ...
  kata.textContent = "Hai sayang, Semangat yaa buat hari ini 😊"
}
